...
Welcome to my Tic Tac Toe game built using React! This simple web application allows users to play the classic Tic Tac Toe game against each other.

## Features

- **Responsive Design:** Play the game on various screen sizes.
- **Turn Indicator:** Clearly see whose turn it is to make a move.
- **Winner Announcement:** The game announces the winner or a draw.
## How to Play
...
This project is licensed under the  @GoutamSachdev 
